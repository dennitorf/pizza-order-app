...
export class OffersService {
  ...
  private OFFERS_DATA : Offer[] = [
    { id : '1', 
      ...
      minPizza : 1, size : SIZE_DATA[1], minToppings : 2, minToppingsPerPizza: 0, discount : 5, percentDiscount : 0},
    { id : '2', 
      description : '2 Medium Pizza with 4 toppings each', 
      minPizza: 2, size : SIZE_DATA[1], minToppings : 0, minToppingsPerPizza : 4, discount : 9, percentDiscount : 0},
    { id : '2', 
      description : '1 Large with 4 toppings (Peperoni and Barbecue chiking are counted as 2 toppings)', 
      minPizza: 1, size : SIZE_DATA[2], minToppings : 4, minToppingsPerPizza : 0, discount : 9, percentDiscount : 0},
  ]
